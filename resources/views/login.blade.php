      ...
      <div class="row">
       <!--  <div class="col-xs-8">
        ...
        <div class="col-xs-4">
          ...
          <center><a type="submit" class="btn btn-primary btn-block btn-flat" href="dashboard">Sign In</a></center>
         <!--  <button type="submit" href="dashboard" class="btn btn-primary btn-block btn-flat">Sign In</button> -->
        </div>
