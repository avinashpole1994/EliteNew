...
<body>
  ...
  <div class="container" style="margin-top:0px;"><h3 style="margin-top:0px; padding:8px;color:#fff; background:#ed1c24; font-size:22px;text-align:center;margin-bottom:15px;" class="hidden-xs hidden-sm">Login</h3>
  </div>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-xs-12 col-md-offset-4">
        <div class="white-bg">
          <form name="login_form" id="login_form" method="POST" action="login">
            ...
            <h3 style="margin-top:0px; padding:8px;color:#fff; background:#ed1c24; font-size:22px;text-align:center;margin-bottom:15px;" class="hidden-lg hidden-md">LOGIN</h3>

            <label class="col-md-12">
            <div>Username</div>
             <input type="text" class="form-control" name="email" id="email" Placeholder="Username" required="required" autofocus="autofocus">
             @if ($errors->has('email'))<label class="control-label" style="color:red" for="inputError" > {{ $errors->first('email') }}</label>  @endif
            </label>
            ...
            @if ($errors->has('password')) <label class="control-label" style="color:red" for="inputError">{{ $errors->first('password') }} </label> @endif
            </label>
            ...
            <div class="pad-tp-btm"><a href="#">Forgot Your Password?</a>
            </div>
            <div>
